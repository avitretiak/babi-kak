...
constexpr ptrdiff_t dwSensitivity = 0xDA22EC;
constexpr ptrdiff_t dwSensitivityPtr = 0xDA22C0;
...
constexpr ptrdiff_t dwYawPtr = 0xD1CD0002;
...
constexpr ptrdiff_t find_hud_element = 0x2E5EE320;
